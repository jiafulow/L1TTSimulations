...
NtupleTrackingParticles::NtupleTrackingParticles(const edm::ParameterSet& iConfig) :
  ...
  maxN_    (iConfig.getParameter<unsigned>("maxN")) {
    ...
    token_ = consumes<TrackingParticleCollection>(inputTag_);
...
NtupleTrackingParticles::~NtupleTrackingParticles() {}
...
void NtupleTrackingParticles::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
    ...
    std::unique_ptr<std::vector<bool> >     v_signal   (new std::vector<bool>());
    std::unique_ptr<std::vector<bool> >     v_intime   (new std::vector<bool>());
    std::unique_ptr<std::vector<bool> >     v_primary  (new std::vector<bool>());
    std::unique_ptr<std::vector<int> >      v_pdgId    (new std::vector<int>());
    std::unique_ptr<std::vector<int> >      v_trkId    (new std::vector<int>());
    std::unique_ptr<std::vector<int> >      v_genpId   (new std::vector<int>());
    std::unique_ptr<std::vector<unsigned> > v_evtId    (new std::vector<unsigned>());
    std::unique_ptr<std::vector<std::vector<unsigned> > > v_trkIds (new std::vector<std::vector<unsigned> >());
    std::unique_ptr<std::vector<std::vector<unsigned> > > v_genpIds(new std::vector<std::vector<unsigned> >());
    ...
    iEvent.put(std::move(v_nhits)    , prefix_ + "nhits"     + suffix_);
    iEvent.put(std::move(v_ntkhits)  , prefix_ + "ntkhits"   + suffix_);
    iEvent.put(std::move(v_ntklayers), prefix_ + "ntklayers" + suffix_);
    iEvent.put(std::move(v_signal)   , prefix_ + "signal"    + suffix_);
    iEvent.put(std::move(v_intime)   , prefix_ + "intime"    + suffix_);
    iEvent.put(std::move(v_primary)  , prefix_ + "primary"   + suffix_);
    iEvent.put(std::move(v_pdgId)    , prefix_ + "pdgId"     + suffix_);
    iEvent.put(std::move(v_trkId)    , prefix_ + "trkId"     + suffix_);
    iEvent.put(std::move(v_genpId)   , prefix_ + "genpId"    + suffix_);
    iEvent.put(std::move(v_evtId)    , prefix_ + "evtId"     + suffix_);
    iEvent.put(std::move(v_trkIds)   , prefix_ + "trkIds"    + suffix_);
    iEvent.put(std::move(v_genpIds)  , prefix_ + "genpIds"   + suffix_);
