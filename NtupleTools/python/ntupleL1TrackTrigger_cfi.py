...
ntupleTTClusters = cms.EDProducer('NtupleTTClusters',
    ...
    inputTagMC = cms.InputTag('TTClusterAssociatorFromPhase2TrackerDigis', 'ClusterInclusive'),
...
ntupleTTStubs = cms.EDProducer('NtupleTTStubs',
    ...
    inputTagMC = cms.InputTag('TTStubAssociatorFromPhase2TrackerDigis', 'StubAccepted'),
